...
SELECT type AS card_type, COUNT(*) AS card_count
FROM bank.card
GROUP BY card_type
...
-- Query 16: In the loan table, retrieve the number of loans issued for each day, before (excl) 930907, ordered by date
-- in descending order.
